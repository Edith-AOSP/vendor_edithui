...
Usage:
  python3 scripts/generate_wallpapers.py [--input SOURCE_IMAGE] [--output-dir RES_DIR]
...
Default res directory:
  overlay/common/frameworks/base/core/res/res
"""
...
DEFAULT_INPUT = "overlay/common/frameworks/base/core/res/res/drawable-nodpi/default_wallpaper.png"
DEFAULT_RES_DIR = "overlay/common/frameworks/base/core/res/res"
